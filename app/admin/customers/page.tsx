    ...
    <div className="space-y-10 stagger-in">
      ...
      <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-6">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Stakeholders Registry</h1>
            ...
            <TableBody>
              {isLoading ? (
                ...
                customers.map((customer) => (
                  <TableRow key={customer._id} className="border-slate-50 hover:bg-slate-50/50 dark:bg-slate-800/50 transition-colors group">
                    <TableCell className="pl-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <p className="font-black text-slate-800 dark:text-white tracking-tight">{customer.name}</p>
                    ...
                    <TableCell className="py-6">
                      {customer.company ? (
                        <div className="flex items-center gap-2">
                          <div className="h-8 w-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center group-hover:bg-bhutan-maroon/5 transition-colors">
                            <Building className="h-3.5 w-3.5 text-slate-400 group-hover:text-bhutan-maroon" />
                          </div>
                          <span className="font-black text-slate-700 dark:text-slate-200 text-sm tracking-tight">{customer.company}</span>
                        </div>
                      ) : (
                    ...
                    <TableCell className="py-6 pr-8 text-right">
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button variant="ghost" size="icon" className="h-10 w-10 rounded-xl hover:bg-slate-100 dark:bg-slate-800">
                        ...
                        <DropdownMenuContent align="end" className="w-56 rounded-2xl p-2 border-slate-100 dark:border-slate-800 shadow-2xl">
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="rounded-3xl border-none shadow-2xl">
                              <DialogHeader>
                                <DialogTitle className="text-2xl font-black text-slate-900 dark:text-white">Confirm Removal</DialogTitle>
