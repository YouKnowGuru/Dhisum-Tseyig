                ...
                <div className="container relative z-10 px-4 md:px-6">
                    <div className="max-w-3xl mx-auto text-center space-y-4">
                        ...
                        <p className="text-sm md:text-lg text-white/60 font-medium leading-relaxed">
                            The rules and conditions for using Jinda POS. Clear, fair, and designed to protect both you and the platform.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container px-4 md:px-6">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="mt-16 p-8 md:p-12 bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
                            <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Questions About These Terms?</h2>
                            <div className="space-y-4 text-slate-600 dark:text-slate-300 font-medium text-sm leading-relaxed">
                                <p>
                                    If you have any questions or concerns about these Terms of Service, we are happy to help. Reach out to us and we will respond within 3 business days.
                                </p>
                                <p>
