                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">20+ Features in One Package</h2>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative p-8 md:p-12 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-2xl space-y-8">
                                <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Our Core Values</h3>
                                <div className="space-y-8">
                                    {values.map((v, i) => (
                                        <div key={i} className="flex gap-6 group">
                                            <div className="h-14 w-14 flex-shrink-0 rounded-2xl bg-slate-50 dark:bg-slate-900/50 flex items-center justify-center text-slate-400 group-hover:bg-bhutan-maroon group-hover:text-bhutan-gold transition-all duration-500 shadow-inner">
                                                <v.icon className="h-7 w-7" />
                                            </div>
                                            <div className="space-y-2">
                                                <h4 className="text-lg font-black text-slate-900 dark:text-white group-hover:text-bhutan-maroon transition-colors">{v.title}</h4>
                                                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">{v.description}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
            ...
            <section className="py-20 md:py-32 bg-slate-50 dark:bg-slate-900/50 relative overflow-hidden">
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="flex flex-col items-center text-center mb-16 md:mb-20">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">The People Behind the Software</h2>
                    </div>
                            ...
                            <div className="absolute bottom-8 left-8 right-8">
                                <div className="glass-premium p-8 rounded-[2.5rem] border border-white/30 backdrop-blur-xl relative overflow-hidden group/quote shadow-2xl">
                                    ...
                                    <div className="space-y-4 relative z-10">
                                        <p className="text-sm md:text-base text-slate-900 dark:text-white font-bold leading-relaxed italic">
                                    ...
                                    <div className="mt-8 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-1">Founder & Lead Developer | Tsirang, Bhutan</p>
                                        </div>
            ...
            <section className="py-20 bg-bhutan-maroon text-white relative overflow-hidden">
                <div className="container text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/download">
                            <Button size="lg" className="bg-bhutan-gold text-bhutan-maroon-dark hover:bg-white dark:bg-slate-900 hover:text-bhutan-maroon font-black h-14 px-8 rounded-2xl shadow-xl transition-all">
                                Download Free Trial
                            </Button>
                        </Link>
                        <Link href="/contact">
